...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Sign Up - You'reHired</title>
        ...
        <div class="min-h-screen flex items-center justify-center px-4 py-12">
            <div class="w-full max-w-md">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-600">Select your account type to get started</p>
                </div>
                ...
                <div class="auth-card">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <a href="{{ route('company.register.form') }}" class="flex items-center p-5 bg-white rounded-2xl border-2 border-slate-200 hover:border-blue-300 hover:shadow-md transition-all duration-300 text-left">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 mt-1">Create a company portal to manage recruitment</p>
                            </div>
                        </a>

                        <!-- Job Seeker Registration -->
                        <a href="{{ route('jobseeker.register.form') }}" class="flex items-center p-5 bg-white rounded-2xl border-2 border-slate-200 hover:border-teal-300 hover:shadow-md transition-all duration-300 text-left">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-600 mt-1">Create profile to apply for jobs</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="mt-6 pt-6 border-t border-slate-200">
                        <div class="text-center">
                            ...
                            <div class="mt-3">
                                <a href="{{ route('login') }}" class="inline-block w-full px-6 py-3 bg-gradient-to-r from-slate-500 to-slate-700 text-white font-semibold rounded-xl shadow hover:shadow-lg transition-all duration-300">
                                    Log In
                                </a>
                            </div>
                        </div>
