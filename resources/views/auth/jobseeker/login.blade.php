    ...
    <body class="antialiased font-sans bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
                <form method="POST" action="{{ route('jobseeker.login') }}" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            name="email"
                            value="{{ old('email') }}"
                            class="w-full px-4 py-3 text-slate-900 rounded-xl border-2 border-slate-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-300 @error('email') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            id="password" 
                            name="password"
                            class="w-full px-4 py-3 text-slate-900 rounded-xl border-2 border-slate-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all duration-300 @error('password') border-red-500 @enderror"
                            placeholder="••••••••"
                            required
                        >
                        @error('password')
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input 
                                ...
                                id="remember" 
                                name="remember"
                                class="w-4 h-4 rounded text-teal-500 focus:ring-teal-500 border-slate-300"
                            >
                    ...
                    <!-- Login Button -->
                    <button type="submit" class="w-full px-6 py-3 bg-gradient-to-r from-teal-500 to-green-600 text-white font-semibold rounded-xl shadow hover:shadow-lg hover:from-teal-600 hover:to-green-700 transition-all duration-300">
                        Log in to Dashboard
                    </button>
                </form>
